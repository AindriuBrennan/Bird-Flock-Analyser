...
public class MainController {
	 ...
	 */
	public  Image blackAndWhite(Image thisImage) {
	...
	/**
	 * 
	 * @param takes in an image that will be manipulated
	 * @colorSliders change the color values of an image by using sliders.
	 */
	...
	public int find(int[] birdDisjointSet, int root) {
	...
	public void birdUnion(int[] birdDisjointSet, int a, int b) {
